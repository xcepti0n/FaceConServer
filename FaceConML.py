...
#loadcsv file
def predict_using_classifier(model,tweets,followers,following,likes,lists,has_url,location):
    #loadcsv file
...
def naive_bayes(tweets,followers,following,likes,lists,has_url,location):
    model = GaussianNB()
    return predict_using_classifier(model,tweets,followers,following,likes,lists,has_url,location)
